...
local highligths = {
	...
	NeogitDiffDelete = { bg = colors.red, fg = colors.red },
	NeogitDiffDeleteHighlight = { bg = colors.red, fg = colors.red },
	...
	NeogitChangeAdded = { fg = colors.green, bg = colors.green, bold = true, italic = true },
