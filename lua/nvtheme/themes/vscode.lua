...
M.polish_hl = {
    ["@variable.parameter"] = { fg = M.colors.blue },
    ["@keyword"] = { fg = M.colors.blue },
    ["@variable"] = { fg = M.colors.cyan },
    ["@variable.member.key"] = { fg = M.colors.green1 },
    ["@keyword.return"] = { fg = M.base_16.base0E },
    ["@keyword.function"] = { fg = M.colors.teal },
}
